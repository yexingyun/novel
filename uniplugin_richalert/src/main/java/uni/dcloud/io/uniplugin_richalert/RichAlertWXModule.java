...
//            NovelSdk.init(((Activity) mWXSDKInstance.getContext()).getApplication(), "zqxxmxs_vdsejj", "8p1hc9oRJ8OI51M6");
//            NovelManager.init((Activity) mWXSDKInstance.getContext(), "456789", new NovelTxcCallback());
        }
    }
